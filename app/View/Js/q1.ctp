...
function addRow(row)
{
var i = document.getElementById("myP").childNodes.rowIndex;
var tr = document.getElementById('Table').insertRow(i+1);
tr.innerHTML = document.getElementById("myP").childNodes.innerHTML;
var inputs = tr.querySelectorAll("td[id='mytd']");
...
<thead>
<th><span id="add_item_button" class="btn mini green addbutton" onclick="addRow(this)">
...
<tbody id='Table'>
	<tr id = "myP">
	<td id = "mytd"></td>
	<td id = "mytd"><p contenteditable="true" name="date[1][description]" ></p></td>
	<td id = "mytd"><p contenteditable="true" name="date[1][quantity]" ></p></td>
	<td id = "mytd"><p contenteditable="true" name="date[1][unit_price]" ></p></td>
